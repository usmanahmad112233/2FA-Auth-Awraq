...
import { QrCode, Scan, Shield, EyeOff, Key, ShieldCheck, Clock, Smartphone, Lock, BookOpen, GraduationCap, Lightbulb, Compass } from "lucide-react";
...
export const GuidesFooter: React.FC = () => {
  return (
